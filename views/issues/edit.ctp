<?php $this->pageTitle = "Editing Issue {$this->data['Issue']['id']}"?>
<div class="row">
  ...
  <?php
    ...
    echo $this->Form->input('status', array('options' => $statuses, 'div' => array('class' => 'clearfix')));
  ?>
  </fieldset>
  <div class="actions">
    <?php echo $this->Form->button(__('Update Issue', true), array('class' => 'btn primary'))?>
  </div>
